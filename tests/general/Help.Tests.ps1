...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Paradox.Modding.Stellaris\functions", "$global:testroot\..\Paradox.Modding.Stellaris\internal\functions"),
	
	[string]
	$ModuleName = "Paradox.Modding.Stellaris",
...
$CommandPath = @(
    "$global:testroot\..\Paradox.Modding.Stellaris\functions"
    "$global:testroot\..\Paradox.Modding.Stellaris\internal\functions"
)
