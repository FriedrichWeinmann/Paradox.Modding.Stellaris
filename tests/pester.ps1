...
Remove-Module Paradox.Modding.Stellaris -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Paradox.Modding.Stellaris\Paradox.Modding.Stellaris.psd1"
Import-Module "$PSScriptRoot\..\Paradox.Modding.Stellaris\Paradox.Modding.Stellaris.psm1" -Force
